...
export { EnumNutritionalGoalFilter } from './enum-nutritional-goal-filter.input';
export { EnumNutritionalGoalWithAggregatesFilter } from './enum-nutritional-goal-with-aggregates-filter.input';
...
export { NutritionalGoal } from './nutritional-goal.enum';
