...
export type MeQuery = { __typename?: 'Query', me: { __typename?: 'UserModel', email: string, id: string, role: Role, profile?: { __typename?: 'ProfileModel', fullName: string, age?: number | null, gender?: Gender | null, bio?: string | null } | null } };
